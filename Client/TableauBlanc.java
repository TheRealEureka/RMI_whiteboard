...
public class TableauBlanc implements ServiceTableauBlanc,Serializable {
    JPanel    canevas;
    ...
    public TableauBlanc(ServiceDistributeur dist)  {
        this.dist=dist;
